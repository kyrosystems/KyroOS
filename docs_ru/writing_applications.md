...
Более подробные примеры и понимание того, как создаются системные утилиты, можно найти в существующих приложениях в [каталоге `userspace/` репозитория KyroOS](https://github.com/kyrosystems/KyroOS/tree/main/userspace). 
