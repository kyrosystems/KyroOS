...
Примеры приложений пользовательского пространства можно найти в каталоге `userspace/` в [репозитории KyroOS](https://github.com/kyrosystems/KyroOS). Приложения, такие как `init` и `shell`, служат хорошей отправной точкой для понимания процесса сборки и взаимодействия с ядром.
